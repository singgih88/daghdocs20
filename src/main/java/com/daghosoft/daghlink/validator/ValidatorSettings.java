...
@Component
public class ValidatorSettings implements Validator {

	private static final Logger logger = LoggerFactory.getLogger(ValidatorSettings.class);
	...
	public void validate(Object target, Errors errors) {
		...
		logger.debug("################################## Begin Validation Process");
		...
		Long maxSize = NumberUtils.toLong(serviceProperty.get("general.upload.size.limit.avatar")); 
